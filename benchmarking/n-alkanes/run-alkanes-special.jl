...
res = jHF(C16, basis; printlevel=1, damping=true, maxiter=200, HFtype=WFmethod)

#for i in [1,2,3,4,5,6]
#    println("DIIS startiter: $i")
#    res = jHF(C14, basis; printlevel=1,diis=true, diis_startiter=i, damping=true, maxiter=200, HFtype=WFmethod)
