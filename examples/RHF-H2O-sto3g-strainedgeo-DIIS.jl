...
energy= jSCF(H2O, "sto-3g"; maxiter=7, diis=true, diis_size=5, levelshift=false, damping=false,damping_thresh=0.001,
    fock_algorithm="loop", WFtype="RHF", printlevel=2)

#energy= jSCF(H2O, "sto-3g"; maxiter=150, diis=false, levelshift=false, damping=true, damping_thresh=0.00001,
#    fock_algorithm="loop", WFtype="RHF", printlevel=1)
