...
@testset "RHF/STO-3G on H2O (default)" begin
    #Simple call
    result= jSCF(H2O, "sto-3g"; printlevel=0, maxiter=20)
...
@testset "RHF/def2-SVP on H2O (default)" begin
    #Simple call
    result= jSCF(H2O, "def2-svp"; printlevel=0, maxiter=20)
    #RHF/STO-3G H2O from ORCA
...
@testset "RHF/def2-TZVPP on H2O (default)" begin
    #Simple call
    result= jSCF(H2O, "def2-tzvpp"; printlevel=0, maxiter=20)
    #RHF/STO-3G H2O from ORCA
...
@testset "RHF/def2-QZVPP on H2O (default)" begin
    #Simple call
    result= jSCF(H2O, "def2-qzvpp"; printlevel=0, maxiter=20)
    #RHF/STO-3G H2O from ORCA
